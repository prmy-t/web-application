...
(function updateModules () {
  ...
  resolveStoreModules(require('../store/availableSubjects.js'), 'availableSubjects.js')
  resolveStoreModules(require('../store/badge.js'), 'badge.js')
  resolveStoreModules(require('../store/faculty.js'), 'faculty.js')
  resolveStoreModules(require('../store/general.js'), 'general.js')
